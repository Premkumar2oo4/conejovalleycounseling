    ...
    [1546], {
        91546: (t, e, r) => {
            ...
            var P = function(t) {
                function e(t, r) {
                    var n, s, u, c;
                    return (0, i.A)(this, e), s = this, u = e, c = [t, A(A({}, e.defaultProps), r)], u = (0, o.A)(u), (n = (0, a.A)(s, T() ? Reflect.construct(u, c || [], (0, o.A)(s).constructor) : u.apply(s, c))).createResources(), n
                }
                return (0, s.A)(e, t), (0, n.A)(e, [{
                    key: "createResources",
                    value: function() {
                        var t = this.props,
                            e = t.image,
                            r = t.uniforms;
                        this.texture = new p.A({
                            image: e
                        }), this.drawInfo = (0, h.A)({
                            program: this.createProgram(),
                            uniforms: A(A(A({}, r), this.getUniformsFromProps()), {}, {
                                uvMatrix: y()(),
                                uImage: (0, v.A)(this.renderer, this.texture),
                    ...
                    key: "render",
                    value: function() {
                        (0, m.A)(this.renderer, this.drawInfo)
                    }
                }, {
                    key: "onRefresh",
                    value: function() {
                    ...
                    value: function() {
                        ! function(t) {
                            var e, r, i = t.matrix,
                                ...
                                p = void 0 === c ? .5 : c,
                                h = t.centerY;
                            s / u > a / o ? (e = a * u / (o * s), r = 1) : (e = 1, r = o * s / (a * u));
                            var v = (e - 1) / 2 * -1,
                                g = (r - 1) / 2 * -1,
                                l = v + (p - .5) * v * 2,
                                m = g + (.5 - (void 0 === h ? .5 : h)) * g * 2;
                            (0, f.i)(n), (0, f.t)(n, n, [l, m]), (0, f.s)(n, n, [e, r])
                        }({
        ...
        89500: (t, e, r) => {
            ...
            var n = function(t, e, r) {
                var i = e[0],
                    ...
                    v = r[0],
                    g = r[1];
                return t[0] = i, t[1] = n, t[2] = a, t[3] = o, t[4] = s, t[5] = u, t[6] = v * i + g * o + c, t[7] = v * n + g * s + p, t[8] = v * a + g * u + h, t
            };
            ...
            var i = r(42512),
                ...
                a = (0, i._)(function t() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        ...
                        T = void 0 !== A && A;
                    (0, i.a)(this, t), this.image = a, this.minFilter = s, this.magFilter = c, this.wrapS = h, this.wrapT = g, this.format = m, this.type = d, this.flipY = x, this.premultiplyAlpha = T, this.generateMipmap = this.minFilter !== n._Q && this.minFilter !== n.te, this.needsUpdate = !1
                })
        },
        65814: (t, e, r) => {
            "use strict";
            ...
            function u(t, e) {
                ...
                return u || (u = function() {
                    return function(t, e, r) {
                        var a = t.gl,
                            u = t.properties.get(e);
                        return (0, i.A)(t.state, r), u.glTexture ? ((0, n.A)(t.state, u.glTexture, r), !0 === e.needsUpdate && (o(t.state, e, u.glTexture), e.needsUpdate = !1)) : (u.glTexture = a.createTexture(), (0, n.A)(t.state, u.glTexture, r), (0, s.A)(a, e), o(t.state, e, u.glTexture)), r
                    }(t, e, r.nextTextureUnit++)
                }, a.set(e, u)), u
            }
        },
        83839: (t, e, r) => {
            ...
            function i(t, e) {
                var r = e.wrapS,
                    ...
                    a = e.magFilter,
                    o = e.flipY,
                    s = e.premultiplyAlpha;
                t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_S, r), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_T, i), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MIN_FILTER, n), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MAG_FILTER, a), t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL, o), t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL, s)
            }
            r.d(e, {
                A: () => i
            })
